<template>
  <Layout title="Dashboard . Users" :user="user">
    ...
    <div class="bg-gray-100 p-6 rounded shadow">
      <h2 class="text-2xl font-medium mb-5 text-gray-500 uppercase">Users</h2>
      <div class="flex justify-between">
        <div class="shadow flex rounded">
          ...
          />
          <button
            class="w-auto flex justify-end items-center text-blue-500 p-2 hover:text-blue-400"
          >
        ...
        <div>
          <inertia-link
            href="users/create"
            class="px-3 py-1 font-medium shadow bg-blue-500 hover:bg-blue-400 text-white text-sm rounded"
          >
            + New</inertia-link
          >
        </div>
            ...
            >
              <table class="min-w-full shadow-lg">
                ...
                <tbody class="bg-gray-200">
                  ...
                  <tr v-for="user in filters" :key="user.id">
                    <td
                    ...
                    >
                      ...
                      <inertia-link
                        href=""
                        @click.prevent="deletejob(user.id)"
                        class="px-2 py-1 bg-red-500 hover:bg-red-600 text-white text-sm font-medium rounded"
                        >Delete</inertia-link
                      >
                    </td>
                  </tr>
...
export default {
  ...
  props: ["user", "users", "successMessage"],
  ...
  methods: {
    getUsers(page = 1) {
      axios.get("users/paginate?page=" + page).then((res) => {
        this.all = res.data;
      });
    },
