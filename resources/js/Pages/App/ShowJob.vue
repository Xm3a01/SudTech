      ...
      <div class="sm:w-3/4 mx-auto">
        <div>
          <div class="mb-4 mt-10">
            <p class="font-medium" v-html="job.job_description">
              <!-- {{ | striphtml}} -->
            </p>
          </div>
          ...
          <div v-show="job.job_responspilty" class="mb-4">
            ...
            <p class="" v-html="job.job_responspilty">
